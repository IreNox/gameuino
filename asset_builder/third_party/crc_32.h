...
UNS_32_BITS updateCRC32(unsigned char ch, UNS_32_BITS crc)
{
...
bool crc32file(char *name, UNS_32_BITS *crc, long *charcnt)
{
	register FILE *fin;
...
UNS_32_BITS crc32buf(const char *buf, size_t len)
{
	register UNS_32_BITS oldcrc32;
